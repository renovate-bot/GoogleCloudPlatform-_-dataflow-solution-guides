...
module "google_cloud_project" {
  source          = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/project?ref=v32.0.1"
...
module "registry_docker" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/artifact-registry?ref=v32.0.1"
...
module "buckets" {
  source        = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/gcs?ref=v32.0.1"
  project_id    = module.google_cloud_project.project_id
...
module "input_topic" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/pubsub?ref=v32.0.1"
  project_id = module.google_cloud_project.project_id
  name       = "messages"
  subscriptions = {
    messages-sub = {}
...
// Network
module "vpc_network" {
  source     = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-vpc?ref=v32.0.1"
  project_id = module.google_cloud_project.project_id
...
module "regional_nat" {
  ...
  source         = "github.com/GoogleCloudPlatform/cloud-foundation-fabric//modules/net-cloudnat?ref=v32.0.1"
  project_id     = module.google_cloud_project.project_id
  region         = var.region
