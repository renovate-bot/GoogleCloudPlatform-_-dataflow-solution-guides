...
| [Synthetic Data Generation](./use_cases/Synthetic_Data_Generation.md) | Batch synthetic BigQuery tables from a DDL and a reference sample, with a self-hosted LLM on GPU workers |      Beta :factory:       |
